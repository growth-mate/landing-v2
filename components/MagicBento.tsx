	...
	return (
		<>
          ...
          .card--border-glow:hover {
            box-shadow: 0 4px 20px rgba(10, 13, 6, 0.6), 0 0 30px rgba(${glowColor}, 0.15);
          }
          ...
          .particle-container:hover {
            box-shadow: 0 4px 20px rgba(10, 13, 6, 0.4), 0 0 30px rgba(${glowColor}, 0.15);
          }
        ...
        `}
			...
			<BentoCardGrid gridRef={gridRef}>
				<div className={layout === "row" ? "card-row" : "card-responsive grid gap-2"}>
