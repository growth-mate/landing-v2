            ...
            <div className="prose prose-invert prose-lg max-w-none">
              <ReactMarkdown
                components={{
                  ...
                  p: ({ node, ...props }) => <p className="mb-4 text-light/80 leading-relaxed" {...props} />,
                  ul: ({ node, ...props }) => <ul className="list-disc list-inside mb-4 space-y-2" {...props} />,
                  ol: ({ node, ...props }) => <ol className="list-decimal list-inside mb-4 space-y-2" {...props} />,
                  li: ({ node, ...props }) => <li className="text-light/80" {...props} />,
                  a: ({ node, ...props }) => (
                  ...
                  code: ({ node, ...props }) => <code className="bg-light/10 px-1.5 py-0.5 rounded text-sm" {...props} />,
                  pre: ({ node, ...props }) => <pre className="bg-light/10 p-4 rounded-lg overflow-x-auto mb-4" {...props} />,
                }}
              >
                {post.content}
              </ReactMarkdown>
