...
const WordmarkLogo = ({ className = "h-8" }: { className?: string }) => (
  <img src="/growthmate-wordmark.svg" alt="GrowthMate" className={className} />
)

const PartnerLogo = ({ name, className = "" }: { name: string; className?: string }) => (
  <div
    className={`bg-light/5 rounded-lg px-8 py-4 flex items-center justify-center h-16 whitespace-nowrap mx-4 ${className}`}
  >
    <span className="font-medium text-light/70">{name}</span>
  </div>
)
        ...
        <div className="container mx-auto px-6 py-4 flex justify-between items-center">
          ...
          <div className="flex items-center gap-8">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="bg-primary text-dark px-6 py-2 rounded-full font-semibold hover:bg-opacity-90 transition-colors"
            >
              Launch App
            </a>
          </div>
      ...
      <main className="pt-24">
        <section className="container mx-auto px-6 py-20">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl md:text-6xl font-bold mb-4">AI-Powered Web3 Targeting</h1>
        ...
        */}
        ...
        <section id="demo" className="container mx-auto px-6 py-20">
          <h2 className="text-3xl font-bold mb-12 text-center">Experience GrowthMate</h2>
          <div className="space-y-8">
            <DemoCard
              title="Smart Ad Targeting"
              description="See how we optimize ad delivery in real-time"
            ...
            <DemoCard
              title="Personalized Discovery Agent"
              description="Watch our AI curate personalized content feeds"
              exploreUrl="https://chat.growthmate.xyz/"
              height="h-[700px]"
            >
              <iframe
        ...
        <section id="solutions" className="container mx-auto px-6 py-20">
          <h2 className="text-3xl font-bold mb-12 text-center">Solutions for Your Business</h2>
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-light/5 rounded-3xl p-8 text-center">
              <h3 className="text-2xl font-semibold mb-4">For Advertisers</h3>
              ...
              <img
                ...
                className="w-full h-auto rounded-3xl mb-6 mx-auto"
              />
              <div className="space-y-4">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="bg-primary text-dark px-6 py-3 rounded-full font-semibold hover:bg-opacity-90 transition-colors inline-flex items-center gap-2"
                >
            ...
            <div className="bg-light/5 rounded-3xl p-8 text-center">
              <h3 className="text-2xl font-semibold mb-4">For Publishers</h3>
              <p className="text-light/80 mb-6">
